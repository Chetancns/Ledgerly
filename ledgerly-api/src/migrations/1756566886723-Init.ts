...
export class Init1756566886723 implements MigrationInterface {
    name = 'Init1756566886723'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "recurring_transactions" ADD CONSTRAINT "FK_5d1add5e7ab6d1578e71409fafa" FOREIGN KEY ("accountId") REFERENCES "accounts"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "recurring_transactions" DROP CONSTRAINT "FK_5d1add5e7ab6d1578e71409fafa"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_ab59c63725771bd11c6e1d719a"`);
        await queryRunner.query(`DROP TABLE "recurring_transactions"`);
        await queryRunner.query(`DROP INDEX "IDX_27e688ddf1ff3893b43065899f"`);
        await queryRunner.query(`DROP TABLE "budgets"`);
        await queryRunner.query(`DROP INDEX "IDX_65a91cee6272cc0da149807869"`);
        await queryRunner.query(`DROP INDEX "IDX_6bb58f2b6e30cb51a6504599f4"`);
        await queryRunner.query(`DROP TABLE "transactions"`);
        await queryRunner.query(`DROP INDEX "IDX_13e8b2a21988bec6fdcbb1fa74"`);
